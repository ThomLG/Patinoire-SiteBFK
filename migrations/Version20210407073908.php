 ...
 */
final class Version20210407073908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE match_convocation (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE match_convocation_bfk_team (match_convocation_id INT NOT NULL, bfk_team_id INT NOT NULL, INDEX IDX_2C259E0661DD1B58 (match_convocation_id), INDEX IDX_2C259E0659F613E1 (bfk_team_id), PRIMARY KEY(match_convocation_id, bfk_team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE match_convocation_football_match (match_convocation_id INT NOT NULL, football_match_id INT NOT NULL, INDEX IDX_9C1BBBA461DD1B58 (match_convocation_id), INDEX IDX_9C1BBBA4E1DA134D (football_match_id), PRIMARY KEY(match_convocation_id, football_match_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE preinscription CHANGE pre_inscription_phone_number pre_inscription_phone_number VARCHAR(10) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE preinscription CHANGE pre_inscription_phone_number pre_inscription_phone_number VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
